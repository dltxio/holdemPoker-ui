...
import { createTable, getListTable, updateTable } from '../../store/action';
...
const Page = () => {
  ...
  const handleSubmit = (data: any) => {
    ...
    return d(createTable({...table, ...data, _id: undefined}))
    .then(() => d(showAlert({ title: 'Table created successfully.' })))
    .then(() => sleep(1000))
    .then(() => nav('/listTable'))
