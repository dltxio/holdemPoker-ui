...
// Actions
import { getSubAgentDetail, updateSubAgent } from '../../store/action';
...
// Interfaces
import { ISubAgentDetailParam, IUpdateSubAgentParam } from '../../interfaces/CreateSubAgent.interface';

import './EditSubAgent.scss';
...
const Page = () => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    const params: IUpdateSubAgentParam = {
      ...data,
    ...
    try {
      ...
      const res = unwrapResult(await dispatch(updateSubAgent(params)));
  ...
  return (
    <Fragment>
      <div className="edit-sub-agent-content">
        <PageTitle
          text="Edit Sub-Agent"
          mode="bold"
          type="danger"
