...
// Components
import { CheckboxList } from '@/components/shared/checkbox-list/CheckBoxListSubAff';
...
// Actions
import { getSubAffDetail, updateSubAff } from '../../store/action';
import { showAlert } from '@/store/global/action';

// Interfaces
import { ISubAffDetailParam, IUpdateSubAffParam } from '../../interfaces/CreateSubAff.interface';

// Constants
import { ROOT } from '@/constants';

import './EditSubAffiliate.scss';
...
const Page = () => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    const params: IUpdateSubAffParam = {
      ...data,
      ...
      rakeCommision: parseInt(values.rakeCommision),
    ...
    try {
      ...
      const res = unwrapResult(await dispatch(updateSubAff(params)));
  ...
  return (
    <Fragment>
      <div className="edit-sub-affiliate-content">
        <PageTitle
          text="Edit Sub-Affiliate"
          mode="bold"
          type="danger"
          icon="bi-gear"
        />
