  ...
  const getDetail = async (id: string) => {
    ...
    if (res.payload.length > 0) {
      ...
      setData({
        id,
        ...leaderBoard,
        startDate: dayjs(leaderBoard.startTime), endDate: dayjs(leaderBoard.endTime),
        ...ranks,
        ...terms,
  ...
  return (
    <Fragment>
      <div className="create-leaderboard-content">
        {/* <Breadcrumb /> */}
        <CustomBreadcrumb modules={['Leaderboard Management','List LeaderBoard','Edit LeaderBoard']}/>
        <div className="create-leaderboard-content__wrapper">
          ...
          <CreateLeaderboardForm action={LeaderBoardActionEnum.edit} initialValues={data} submitText={'Update'} />
        </div>
      </div>
    </Fragment>
  )
