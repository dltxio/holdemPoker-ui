  ...
  return (
    <Fragment>
      <div className="create-leaderboard-content">
        <CustomBreadcrumb modules={['Leaderboard Management','List LeaderBoard','View LeaderBoard']}/>
        <div className="create-leaderboard-content__wrapper">
          ...
          <CreateLeaderboardForm action={LeaderBoardActionEnum.view} initialValues={data} submitText={'Back'} />
        </div>
      </div>
    </Fragment>
  )
