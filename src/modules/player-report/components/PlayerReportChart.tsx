...
export type PlayerReportChartViewProps = {
  title: string,
...
const PlayerReportChartView = ({ title, loadData }: PlayerReportChartViewProps) => {
...
export default PlayerReportChartView;