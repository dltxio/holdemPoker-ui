...
const CheckboxList = forwardRef<ForwardedRef, Props>(({ data, checkedModules, viewMode, onChange }, forwardedRef) => {
  ...
  return (
    ...
    //                         onChange={handleOnChange}
    //                     />
    //                     {level0.subModule && level0.subModule.length && level0.subModule.some((level1: any) => level1.checked) && (
    //                         <ul key={getUniqueKey()}>
    //                             {level0.subModule.map((level1: any) => {
    //                                 if (level1.checked) {
    //                                     return (
    ...
    //                                                 onChange={handleOnChange}
    //                                             />
    //                                             {level1.subModule && level1.subModule.length && level1.subModule.some((level2: any) => level2.checked) && (
    //                                                 <ul key={getUniqueKey()}>
    //                                                 {level1.subModule.map((level2: any) => (
    //                                                     level2.checked && 
    //                                                     <li key={getUniqueKey()} className="level2">
